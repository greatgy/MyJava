...
//instance=new Singleton()创建对象的过程分为：1分配对象的内存空间  2初始化对象  3变量指向分配的内存地址
//双重锁
class Singleton2 {
	private Singleton2(){}
...
class InstanceFactory{
	...
	private static class InstanceHolder{
		static InstanceFactory instance = new InstanceFactory();//类初始化是是同步执行的保证只初始化一次，  此时创建对象同样会重排序优化，但是同步下对其他线程不看见
	} 
